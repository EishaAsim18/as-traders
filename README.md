# [Project Name: A & S Traders]
### Subtitle: A Full-Stack E-Commerce & Shop Management System for Sanitary Ware & Fittings (Multan, Pakistan)
...
- **Secrets:** `JWT_SECRET`, `MONGODB_URI`, and admin credentials stored in `.env` (not committed to Git).
...
5. **Start the server:**
   ...
   npm start
   ```
   > **Important:** Open the app at **http://localhost:3000** — do not use VS Code Live Server. Customer and admin pages call `/api/*` on the same origin.
...
| # | Name | Role |
|---|------|------|
| 1 | Saleha Khurram | Customer frontend |
| 2 | Eisha Asim | Admin frontend |
| 3 | Izzat Rehman | Backend & API |
| 4 | Sadia Noor | Database |
...
## Submission checklist (Classroom)
- [ ] Project documentation — **Word + PDF** (use this README as source)
- [ ] Separate **Word file** with screenshots of all major screens
- [ ] **Video demo** of the working project
- [ ] Live demo links working (Vercel + Railway)
